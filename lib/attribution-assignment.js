...
async function closeAllocationPool() { if(allocationPool){const current=allocationPool;allocationPool=undefined;await current.end();} }
module.exports={closerIds,reserveCloser,closeAllocationPool};
